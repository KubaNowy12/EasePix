...
namespace EasePixEditor.GameDev
{
    ...
    static class VisualStudio
    {
                ...
                if (_vsInstance == null)
                {
                    ...
                    while (monikerTable.Next(1, currentMoniker, IntPtr.Zero) == 0)
                    {
                        ...
                        if (name.Contains(_progID))
                        {
                            ...
                            if (hResult < 0 || obj == null) throw new COMException($"Running object table's GetObect() returned HRESULT: {hResult:X8}");
        ...
        private static void OnBuildSolutionBegin(string project, string projectConfig, string platform, string solutionCofig)
        {
            if (BuildDone) return;
            Logger.Log(MessageType.Info, $"Building {project}, {projectConfig}, {platform}, {solutionCofig}");
        }

        private static void OnBuildSolutionDone(string project, string projectConfig, string platform, string solutionCofig, bool success)
        {
            if (BuildDone) return;
        ...
        public static void BuildSolution(Project project, BuildConfiguration buildConfig, bool showWindow)
        {
