...
void create_plane(scene&, const primitive_init_info& info);
void create_cube(scene&, const primitive_init_info& info);
void create_uv_sphere(scene&, const primitive_init_info& info);
...
void
create_cube(scene&, const primitive_init_info& info)
{

}

void
create_uv_sphere(scene&, const primitive_init_info& info)
{

}

void
create_ico_sphere(scene&, const primitive_init_info& info)
{

}

void
create_cylinder(scene&, const primitive_init_info& info)
{

}

void
create_capsule(scene&, const primitive_init_info& info)
{
